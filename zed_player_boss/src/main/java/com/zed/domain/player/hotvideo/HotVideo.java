 ...
 * @description : 热门影片
*/
public class HotVideo extends BaseModel {
	...
	private int subtitleCount; // 字幕数量
	private int subtitleFileCount; // 字幕文件数量
    ...
    public void setSubtitleFileCount(int subtitleFileCount) {
