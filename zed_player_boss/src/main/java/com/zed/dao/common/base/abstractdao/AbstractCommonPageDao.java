package com.zed.dao.common.base.abstractdao;

import java.util.List;
import java.util.Map;

import com.zed.dao.PageDao;
import com.zed.dao.common.base.impl.CommonBaseDaoImpl;
...
public abstract class AbstractCommonPageDao<T> extends CommonBaseDaoImpl<T> implements PageDao<T>{
