package com.zed.dao.account.base.abstractdao;

import java.util.List;
import java.util.Map;

import com.zed.dao.PageDao;
import com.zed.dao.account.base.impl.AccountBaseDaoImpl;
...
public abstract class AbstractAccountPageDao<T> extends AccountBaseDaoImpl<T> implements PageDao<T>{
