package com.zed.dao.server.base.abstractdao;

import java.util.List;
import java.util.Map;

import com.zed.dao.PageDao;
import com.zed.dao.server.base.impl.ServerBaseDaoImpl;
...
public abstract class AbstractServerPageDao<T> extends ServerBaseDaoImpl<T> implements PageDao<T>{
