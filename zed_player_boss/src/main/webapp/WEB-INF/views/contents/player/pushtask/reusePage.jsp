...
<form  method="post" name="form" id="form" enctype="multipart/form-data" action="<s:url action="updateReuse"/>" onsubmit="return false;">
    ...
    <div class="formbody">
    <div class="formtitle"><span>复用消息推送</span></div>
	    <ul class="forminfo">
	   <li>
