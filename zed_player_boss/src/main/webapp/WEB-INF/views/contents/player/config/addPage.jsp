...
<div class="formbody">
<div class="formtitle"><span>添加配置信息</span></div>
...
<s:token name="submittedToken"/>
    <ul class="forminfo">
	    <li>
	    	...
	    	<input name="playerConfig.version" id="playerConfig.version" type="text" class="dfinput validate[required,minSize[1],maxSize[10]]" maxlength="10"/><i class = "tips">请输入版本号</i>
	    </li>
	    <li>
	    	<label style="width:120px;">app包名<font class = "require">*</font></label>
	    	<input name="playerConfig.packageName" id="playerConfig.packageName" type="text" class="dfinput validate[required,minSize[1],maxSize[100]]" maxlength="100"/><i class = "tips">请输入app包名</i>
	    </li>
	    <li>
	    	<label style="width:120px;">google审核状态<font class = "require">*</font></label>
	    	<select name="playerConfig.reviewStatus" class="dayinput form-control" style="width:120px;">
