...
<div class="formbody">
<div class="formtitle"><span>添加ip白名单</span></div>
<form method="post" name="form" id="form" action="<s:url action="add"/>" onsubmit="return false;">
<s:token name="submittedToken"/>
    <ul class="forminfo">
	    <li>
	    	<label style="width:120px;">ip<font class = "require">*</font></label>
	    	<input name="whiteIp" id="whiteIp" type="text" class="dfinput validate[required,custom[ipv4],ajax[isIpExist],minSize[1]]" maxlength="32"/><i class = "tips">请输入ip地址</i>
	    </li>
	   <li>
	    	<label style="width:120px;">地区编号<font class = "require">*</font></label>
	    	<select id="areaCode" name="areaCode" class="dayinput form-control">
