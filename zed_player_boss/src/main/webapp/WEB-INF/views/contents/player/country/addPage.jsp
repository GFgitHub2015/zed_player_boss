...
<div class="formbody">
<div class="formtitle"><span>添加国家码字典信息</span></div>
<form method="post" name="form" id="form" action="<s:url action="add"/>" onsubmit="return false;">
<s:token name="submittedToken"/>
    <ul class="forminfo">
	    <li>
	    	<label style="width:120px;">国家码<font class = "require">*</font></label>
	    	<input name="playerCountry.countryCode" id="playerCountry.countryCode" type="text" class="dfinput validate[required,minSize[1],maxSize[11],custom[onlyNumber],ajax[isCountryExist]]" maxlength="32"/><i class = "tips">请输入国家码</i>
	    </li>
	    <li>
	    	<label style="width:120px;">国家中文名称<font class = "require">*</font></label>
	    	<input name="playerCountry.countryNameZh" id="playerCountry.countryNameZh" type="text" class="dfinput validate[required,minSize[1],maxSize[32],custom[chinese]]" maxlength="32"/><i class = "tips">请输入中文名称</i>
	    </li>
	    <li>
	    	<label style="width:120px;">国家英文名称<font class = "require">*</font></label>
	    	<input name="playerCountry.countryNameEn" id="playerCountry.countryNameEn" type="text" class="dfinput validate[required,minSize[1],maxSize[1024],custom[onlyLetter]]" maxlength="1024"/><i class = "tips">请输入英文名称</i>
	    </li>
	    <li>
	    ...
	    <li>
	    	...
	    	<input name="playerCountry.alpha2" id="playerCountry.alpha2" type="text" class="dfinput validate[required,minSize[2],maxSize[2],custom[onlyLetter]]" maxlength="2"/><i class = "tips">请输入alpha-2</i>
	    </li>
	    <li>
	    	<label style="width:120px;">alpha-3<font class = "require">*</font></label>
	    	<input name="playerCountry.alpha3" id="playerCountry.alpha3" type="text" class="dfinput validate[required,minSize[3],maxSize[3],custom[onlyLetter]]" maxlength="3"/><i class = "tips">请输入alpha-3</i>
	    </li>
	    <li>
	    	<label style="width:120px;">UN numeric-3<font class = "require">*</font></label>
	    	<input name="playerCountry.numeric3" id="playerCountry.numeric3" type="text" class="dfinput validate[required,minSize[3],maxSize[3],custom[onlyNumber]" maxlength="3"/><i class = "tips">请输入UN numeric-3</i>
	    </li>
	    <li>
	    	<label style="width:120px;">是否启用<font class = "require">*</font></label>
	    	<cite>
	    		<input name="playerCountry.status" type="radio" value="0" checked="checked"/>&nbsp;&nbsp;禁用
	    		&nbsp;&nbsp;&nbsp;&nbsp;
	    		<input name="playerCountry.status" type="radio" value="1"/>&nbsp;&nbsp;启用
	    	</cite>
    	</li>
	    <li>
	    	<label>&nbsp;</label>
