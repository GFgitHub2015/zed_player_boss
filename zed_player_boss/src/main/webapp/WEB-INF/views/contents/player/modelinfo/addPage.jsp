...
<div class="formbody">
<div class="formtitle"><span>添加机型适配播放模式信息</span></div>
<form method="post" name="form" id="form" action="<s:url action="add"/>" onsubmit="return false;">
<s:token name="submittedToken"/>
    <ul class="forminfo">
	    <li>
	    	<label style="width:120px;">机型<font class = "require">*</font></label>
	    	<input name="playerModelInfo.model" id="playerModelInfo.model" type="text" class="dfinput validate[required,minSize[1],maxSize[100]]" maxlength="100"/><i class = "tips">请输入机型</i>
	    </li>
	    <li>
	    	<label style="width:120px;">播放模式<font class = "require">*</font></label>
	    	<select name="playerModelInfo.dimension" class="dayinput form-control" style="width:120px;">
