...
<form method="post" name="form" id="form"   action="<s:url action="addVideo3d"/>" onsubmit="return false;">
<s:token name="submittedToken"/>
	...
	<input type="hidden" name="video.dimensionType"   value="3"             id="dimensionType" />
	<input type="hidden" name="video.recommendType"   value="0"             id="recommendType" />
    <div class="formbody">
    <div class="formtitle"><span>新增3D影片</span></div>
	    <ul class="forminfo">
	    <li>
	    	<label>影片URL<font class = "require">*</font></label>
	    	<input name="video.videoUrl" id="videoUrl" type="text" class="dfinput validate[required,minSize[1],maxSize[100]]"  maxlength="100"  /> 
	    </li>
    	<label>&nbsp;</label>
