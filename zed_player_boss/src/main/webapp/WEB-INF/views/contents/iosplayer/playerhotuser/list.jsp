...
<body>
	...
	<form id = "form" action="<s:url action="list" />" method="post" name="form">
		<ul class="seachform">
				<li>
					<label>频道名称：</label>
					<input id="title" name="playerRelationHotUser.title" type="text" class="scinput form-control" maxlength="32" style="width: 300px" value = "${playerRelationHotUser.title}"/>
				</li>
				<li>
					<label>&nbsp;</label>
			...
			<tbody>
				<s:iterator value="page.result" var="list">
					<tr>
						...
						<td><s:property value="#list.subscriberCount" /></td>
						...
						<td>									
							<s:iterator value="buttonMenuList" var="buttonRight">
								<s:if test="%{#buttonRight.resourceLevel == 5}">
									<s:if test="%{#buttonRight.resourceKey == 'menu_ios_player_hot_user_status' and #list.origin != 1}">
									...
									<s:elseif test="%{#buttonRight.resourceKey == 'menu_ios_player_hot_user_updateall' and #list.origin != 1}">
									...
									<s:elseif test="%{#buttonRight.resourceKey != 'menu_ios_player_hot_user_status' and #buttonRight.resourceKey != 'menu_ios_player_hot_user_updateall'}">
