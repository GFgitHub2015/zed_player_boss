...
function clearForm() {
	window.location = '<s:url action="personalUpdatePage" />?adminId=${admin.adminId}';
}
...
<form  method="post" name="form" id="form" action="<s:url action="personalUpdate"/>" onsubmit="return false;">
...
<input type="hidden" name="admin.adminId" id="admin.adminId" value="${admin.adminId}"/>
    ...
    <li><label>手机号码<font class = "require">*</font></label><input name="admin.adminPhone" id="admin.adminPhone" type="text" class="dfinput validate[required,custom[phone],minSize[1],maxSize[30]]" value="${admin.adminPhone}" maxlength="30"/><i class = "tips">请输入手机号码</i></li>
