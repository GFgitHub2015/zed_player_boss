...
<form  method="post" name="form" id="form" action="<s:url action="personalResetPasswd"/>" onsubmit="return false;">
...
<input type="hidden" name="admin.adminPwd" id="admin.adminPwd" value=""/>
    ...
    <ul class="forminfo">
   	...
   	<li>
   		<label>旧密码<font class = "require">*</font></label>
	    <input name="oldPassword" id="oldPassword" type="password" class="dfinput validate[required,minSize[6],maxSize[20]]" maxlength="20" />
