...
<div class="formbody">
<div class="formtitle"><span>添加用户基本信息</span></div>
<form method="post" name="form" id="form" enctype="multipart/form-data" action="<s:url action="add"/>" onsubmit="return false;">
    <ul class="forminfo">
	    <li>
	    	...
	    	<input name="account.nickName" id="account.nickName" type="text" class="dfinput validate[required,minSize[1],maxSize[32],ajax[isNickNameExist]]" maxlength="32"/><i class = "tips">请输入用户昵称</i>
	    </li>
	    <li>
	    	<label style="width:120px;">手机号<font class = "require">*</font></label>
	    	<input name="account.phone" id="account.phone" type="text" class="dfinput validate[required,minSize[1],maxSize[20],ajax[isPhoneExist],custom[phone]]" maxlength="20"/><i class = "tips">请输入手机号</i>
	    </li>
	    <li>
	    	<label style="width:120px;">性别<font class = "require">*</font></label>
	    	<cite>
	    		<input name="account.sex" type="radio" value="3" checked="checked"/>&nbsp;&nbsp;男
	    		&nbsp;&nbsp;&nbsp;&nbsp;
	    		<input name="account.sex" type="radio" value="4"/>&nbsp;&nbsp;女
	    		&nbsp;&nbsp;&nbsp;&nbsp;
	    		<input name="account.sex" type="radio" value="2"/>&nbsp;&nbsp;未知
	    		&nbsp;&nbsp;&nbsp;&nbsp;
	    		<input name="account.sex" type="radio" value="0"/>&nbsp;&nbsp;男（不可修改）
	    		&nbsp;&nbsp;&nbsp;&nbsp;
	    		<input name="account.sex" type="radio" value="1"/>&nbsp;&nbsp;女（不可修改）
	    	</cite>
    	</li>
    	<li>
	    	<label style="width:120px;">地区编号<font class = "require">*</font></label>
	    	<select id="account.areaCode" name="account.areaCode" class="dayinput form-control">
	    ...
	    <li>
	    	...
	    	<cite>
	    		<input name="account.status" type="radio" value="0" checked="checked"/>&nbsp;&nbsp;禁用
	    		&nbsp;&nbsp;&nbsp;&nbsp;
	    		<input name="account.status" type="radio" value="1"/>&nbsp;&nbsp;启用
	    	</cite>
    	</li>
    	<li id = "upLoadImg">
